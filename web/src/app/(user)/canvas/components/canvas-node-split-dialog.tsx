...
type CanvasImageSplitDraft = ImageSplitParams & { horizontalLines: number[]; verticalLines: number[] };

const defaultParams: CanvasImageSplitDraft = { rows: 2, columns: 2, horizontalLines: [0.5], verticalLines: [0.5] };
...
export function CanvasNodeSplitDialog({ dataUrl, open, onClose, onConfirm }: { dataUrl: string; open: boolean; onClose: () => void; onConfirm: (params: CanvasImageSplitParams) => void }) {
    const [params, setParams] = useState<CanvasImageSplitDraft>(defaultParams);
    ...
    const confirmParams: CanvasImageSplitParams = { ...params, horizontalLines, verticalLines, rows, columns };
