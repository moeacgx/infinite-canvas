...
import { AppstoreOutlined, FileTextOutlined, HomeOutlined, LogoutOutlined, PictureOutlined, SettingOutlined, ThunderboltOutlined, TransactionOutlined, UserOutlined } from "@ant-design/icons";
...
const adminMenus = [
    ...
    { key: "/admin/prompt-categories", icon: <AppstoreOutlined />, label: "分类管理" },
    { key: "/admin/prompt-skills", icon: <ThunderboltOutlined />, label: "技能预设" },
...
export default function AdminLayout({ children }: { children: ReactNode }) {
    ...
    const activeKey = pathname.startsWith("/admin/settings")
        ...
        : pathname.startsWith("/admin/assets")
          ? "/admin/assets"
          : pathname.startsWith("/admin/prompt-categories")
            ? "/admin/prompt-categories"
            : pathname.startsWith("/admin/prompt-skills")
              ? "/admin/prompt-skills"
              : pathname.startsWith("/admin/prompts")
                ...
                : pathname.startsWith("/admin/credit-logs")
                  ...
                  : pathname.startsWith("/admin/users")
                    ? "/admin/users"
                    : "";
    const pageTitle = pathname.startsWith("/admin/settings") ? "系统设置" : pathname.startsWith("/admin/assets") ? "素材库管理" : pathname.startsWith("/admin/prompt-categories") ? "分类管理" : pathname.startsWith("/admin/prompt-skills") ? "技能预设管理" : pathname.startsWith("/admin/prompts") ? "提示词管理" : pathname.startsWith("/admin/credit-logs") ? "算力点日志" : "用户管理";
