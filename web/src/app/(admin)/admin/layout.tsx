...
import { AppstoreOutlined, FileTextOutlined, HomeOutlined, LogoutOutlined, PictureOutlined, SettingOutlined, TransactionOutlined, UserOutlined } from "@ant-design/icons";
            ...
            : pathname.startsWith("/admin/prompts")
              ...
              : pathname.startsWith("/admin/credit-logs")
                ...
                : pathname.startsWith("/admin/users")
                  ? "/admin/users"
                  : "";
    const pageTitle = pathname.startsWith("/admin/settings") ? "系统设置" : pathname.startsWith("/admin/assets") ? "素材库管理" : pathname.startsWith("/admin/prompt-categories") ? "分类管理" : pathname.startsWith("/admin/prompts") ? "提示词管理" : pathname.startsWith("/admin/credit-logs") ? "算力点日志" : "用户管理";
