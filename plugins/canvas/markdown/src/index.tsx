...
import { definePlugin, sanitizeHtml, useEffect, useRef, useState } from "@infinite-canvas/plugin-sdk";
...
function renderMarkdown(source: string): string {
    ...
    if (out === undefined) {
        // marked 仅负责语法解析；写入 DOM 前仍需经过宿主净化器，避免脚本和危险 URL。
        out = sanitizeHtml(marked.parse(key));
